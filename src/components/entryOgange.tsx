          ...
          <div className="rounded-2xl p-8 -mt-24 pt-20 border-4" style={{ backgroundColor: '#fee0b6ff', borderColor: '#fc9a47ff' }}>
                ...
                {timeSlots.map((time) => {
                  ...
                  return (
                    <button
                      ...
                      style={selectedTime === time && !isFull ? { backgroundColor: '#fc9a47ff' } : {}}
                    >
            ...
            <div className="text-center">
              <button
                ...
                style={{ 
                  backgroundColor: (!selectedDate || !selectedTime || !formData.name || !formData.email || isSubmitting || (selectedDate && selectedTime ? isSlotFull(selectedDate, selectedTime) : false)) ? '#9ca3af' : '#fc9a47ff' 
                }}
              >
                {isSubmitting ? (
                  <>
