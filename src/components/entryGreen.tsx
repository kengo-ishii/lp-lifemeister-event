...
export default function EntryGreen() {
  ...
  const fullSlots: { [key: string]: string[] } = {
    '2025-11-08': ['10:00〜10:30', '10:30〜11:00', '11:00〜11:30', '11:30〜12:00', '13:00〜13:30', '13:30〜14:00', '14:00〜14:30', '14:30〜15:00'],
    '2025-11-09': ['10:00〜10:30', '10:30〜11:00', '11:00〜11:30', '11:30〜12:00', '13:00〜13:30', '14:00〜14:30', '15:00〜15:30', '16:00〜16:30']
  }
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-12" style={{ maxWidth: '800px', backgroundColor: '#fdfaf3ff' }}>
        <div className="mx-auto" style={{ maxWidth: '760px' }}>
          <div className="text-center mb-12 relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 inline-block px-8 py-4 rounded-full border-2 border-white" style={{ backgroundColor: '#1ea38dff', outline: '8px solid #1ea38dff', outlineOffset: '0px' }}>
              無料で参加する
            </h2>
          </div>

          <div className="rounded-2xl p-8 -mt-24 pt-20 border-4" style={{ backgroundColor: '#d4fffaff', borderColor: '#1ea38dff' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  ...
                  style={selectedDate === '2025-11-08' ? { backgroundColor: '#1ea38dff' } : {}}
                >
                ...
                <button
                  ...
                  style={selectedDate === '2025-11-09' ? { backgroundColor: '#1ea38dff' } : {}}
                >
                ...
                {timeSlots.map((time) => {
                  ...
                  return (
                    <button
                      ...
                      style={selectedTime === time && !isFull ? { backgroundColor: '#1ea38dff' } : {}}
                    >
            ...
            {(selectedDate || selectedTime) && (
              <div className="bg-white p-4 rounded-lg">
                <h4 className="font-semibold mb-2" style={{ color: '#1ea38dff' }}>選択内容</h4>
                {selectedDate && (
                  <p style={{ color: '#1ea38dff' }}>
                    日付: {selectedDate === '2025-11-08' ? '2025年11月8日（土）' : '2025年11月9日（日）'}
                  </p>
                )}
                {selectedTime && (
                  <p style={{ color: '#1ea38dff' }}>時間: {selectedTime}</p>
                )}
              </div>
            )}
            ...
            <div className="text-center">
              <button
                ...
                style={{ 
                  backgroundColor: (!selectedDate || !selectedTime || !formData.name || !formData.email || isSubmitting || (selectedDate && selectedTime ? isSlotFull(selectedDate, selectedTime) : false)) ? '#9ca3af' : '#1ea38dff' 
                }}
              >
                {isSubmitting ? (
                  <>
