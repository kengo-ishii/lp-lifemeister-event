          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="text-center">
              <button
                ...
                className="bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed shadow-lg hover:shadow-xl flex items-center justify-center mx-auto min-w-[200px]"
              >
                {isSubmitting ? (
                  <>
