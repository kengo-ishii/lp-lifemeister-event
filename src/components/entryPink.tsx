...
export default function EntryPink() {
  ...
  return (
    <section className="bg-white">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-12" style={{ maxWidth: '800px', backgroundColor: '#fdd14aff' }}>
        <div className="mx-auto" style={{ maxWidth: '760px' }}>
          ...
          <div className="rounded-2xl p-8 -mt-24 pt-20 border-4" style={{ backgroundColor: '#fee1f2ff', borderColor: '#e4157fff' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  ...
                  style={selectedDate === '2025-11-08' ? { backgroundColor: '#e4157fff' } : {}}
                >
                ...
                <button
                  ...
                  style={selectedDate === '2025-11-09' ? { backgroundColor: '#e4157fff' } : {}}
                >
            ...
            {(selectedDate || selectedTime) && (
              <div className="bg-white p-4 rounded-lg">
                <h4 className="font-semibold mb-2" style={{ color: '#e4157fff' }}>選択内容</h4>
                {selectedDate && (
                  <p style={{ color: '#e4157fff' }}>
                    日付: {selectedDate === '2025-11-08' ? '2025年11月8日（土）' : '2025年11月9日（日）'}
                  </p>
                )}
                {selectedTime && (
                  <p style={{ color: '#e4157fff' }}>時間: {selectedTime}</p>
                )}
              </div>
            )}
