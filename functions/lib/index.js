...
exports.sendEventReservationHttp = exports.sendEventReservation = void 0;
...
exports.sendEventReservation = functions.region('asia-northeast1').https.onCall(async (data, context) => {
    try {
        // メールパスワードの取得
...
exports.sendEventReservationHttp = functions.region('asia-northeast1').https.onRequest(async (req, res) => {
    // CORS
    ...
    try {
      ...
      `
        ...
        const msg = (error === null || error === void 0 ? void 0 : error.message) || 'メール送信に失敗しました';
